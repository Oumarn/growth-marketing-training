    ...
    <footer className="bg-gray-50 border-t">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">FastLearn</h3>
            <p className="text-gray-600 text-sm">
              Formation complète Growth Marketing de 2 jours (14h) pour maîtriser les fondamentaux 
              du Growth Marketing et l'automatisation avec l'IA.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/download" className="text-gray-600 hover:text-gray-900">Ressources</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-center text-gray-500 text-sm">
            © 2025 FastLearn - Growth Marketing Formation. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
